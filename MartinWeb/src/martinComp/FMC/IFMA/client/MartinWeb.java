 ...
 */
public class MartinWeb implements EntryPoint {
	/**
	...
	public void onModuleLoad() {
		...
		rootPanel.add(passwordLabel, 366, 380);
		
		TextBox usernameTextBox = new TextBox();
		rootPanel.add(usernameTextBox, 309, 340);
		
		Label usernameLabel = new Label("Username");
		rootPanel.add(usernameLabel, 367, 316);
